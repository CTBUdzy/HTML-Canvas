$(document).ready(function(){
	...
	var notice = null;
	//转盘初始化
	var color = ["rgb(248,232,208)","rgb(227,236,172)","rgb(142,185,75)","rgb(180,66,35)","white","rgb(255,66,93)"];
	var info = ["谢谢参与"," 吃个","漂亮衣服","可爱包包","YSL口红"," 想去哪玩","52元","去逛街"];
	var info1 = ['再接再厉','  痛快','   一件','   一个','   一只',' 就去哪','现金红包',' 随便选']
	canvasRun();
